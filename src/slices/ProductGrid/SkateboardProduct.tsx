...
async function getDominantColor(url:string) {
    ...
    console.log(json.dominant_colors)
...
export async function SkateboardProduct({id}: Props) {
  ...
  return (
    <div className='group relative mx-auto w-full max-w-72 px-8 pt-4'>
        ...
        <div className='-mb-1 overflow-hidden py-4 md:h-[520]'>
        ...
        <div className="absolute bottom-[70px] left-0 right-0 flex items-end justify-center opacity-0 transition-opacity duration-200 group-hover:opacity-100">
