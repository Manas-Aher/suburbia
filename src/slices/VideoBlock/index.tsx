...
const MASK_CLASSES = 'absolute inset-0 [mask-image:url(/video-mask.png)] [mask-mode:alpha] [mask-position:center_center] [mask-repeat:no-repeat] [mask-size:100%_auto]'
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video">
        ...
        <div className={clsx( MASK_CLASSES, 'bg-white absolute inset-0 ~translate-x-1/3 ~-translate-y-1/3')} />
        {/* Video */}
